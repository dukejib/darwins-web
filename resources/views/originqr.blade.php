        ...
        <div class="col-md-12">
            <div class="panel panel-primary">
                <div class="panel-heading text-center">
                    <h5>The Origins of QR Code</h5>
                </div>

                <div class="panel-body">

                    <p class="myp">
                        <img src="{{ asset('img/pic4.jpg') }}" class="thumbnail img-responsive" alt="Cuecat" style="float: left;margin-right:20px;" width="180px" >
                        The <strong>:CueCat</strong> was a barcode scanner manufactured by <strong>Digital Convergence</strong> in the early 2000&apos;s and was heralded as a revolutionary technology.<br>
                        It was a little white plastic cat with a built-in infrared sensor that would plug into your computer&apos;s PS2 port and scan special barcodes <strong>(and regular barcodes)</strong> which would then take you to a related website. More specifically, the product and associated intellectual property would instantly and directly link product <strong>UPC, EAN, ISBN</strong> as well as the unique <strong>:CRQ Cue Codes</strong><img src="{{ asset('img/cuecat.gif') }}" width="60px"> to their appropriate websites. Usually these were to links buried deeply within a site which could be further targeted demographically or geographically.<br>
                        To get the device in the hands of consumers, Digital Convergence mailed them out to subscribers of high profile tech magazines like Wired or through its vendor <strong>RadioShack Corporation</strong>. The unique :CRQ Cue Codes were placed within traditional media content and some advertisements in publications like Wired Magazine, Forbes and its specialty magazines, Parade Magazine and several Daily Newspapers. Product Cues were also placed in many catalogs to facilitate instant e-commerce shopping and the automation of wish lists <strong>(such as RadioShack&apos;s catalogs)</strong>. As you can imagine, this technology could eliminate search with "laser beam" accuracy.
                    </p>
                    <br>
                    <br>
                    <p class="myp">
                        <img src="{{ asset('img/pic2.jpg') }}" class="thumbnail img-responsive" alt="Cuecat" style="float: right;margin-left:20px;" width="180px" >
                        Some thought that the <strong>:CueCat</strong> was going to be huge for a long time, but it wasn&apos;t. So what happened? As the "tethered" <strong>:CueCat</strong> was just beginning to continue its recognition to consumers, other "store and forward" or "bookmark life" concepts such as portable scanners like the one manufactured by Cross as a pen, and a keychain scanner were ultimately cost-reduced and readied for deployment.<br>
                        Also the dot-com crashed and advertising money around <strong>:CueCat</strong> started to crumble. Furthermore, there was an abundant of bad press related to a discovery that <strong>:CueCat</strong> devices were sending information on its users back to its servers. Some hackers posted instructions on how to stop it from reporting your info back to Digital Convergence. In response Digital Convergence threatened to sue the hackers. It was a big mess. But the real reason it didn&apos;t pop off was because it just wasn&apos;t that appealing of a product at the time. Unlike your phone, the <strong>:CueCat </strong> was tethered to your desk and in 2000 the interactivity of the Internet wasn&apos;t what it is today. The market just wasn&apos;t ready; and neither was the product.

                    </p>
                    <br>
                    <br>
                    <p class="myp">
                        <img src="{{ asset('img/pic3.jpg') }}" class="thumbnail img-responsive" alt="Cuecat" style="float: left;margin-right:20px;" width="180px" >
                    ...
                    <table>
                        <tr>
                            <td><video width="480" height="360" controls style="float: left" class="img-responsive">
                            ...
                            <td>&nbsp;</td>
                            <td>
                                <video width="480" height="360" controls style="float: right" class="img-responsive">
