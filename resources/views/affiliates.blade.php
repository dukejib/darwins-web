        ...
        <div class="col-md-12">
            <div class="panel panel-primary">
                ...
                <div class="panel-heading text-center">
                    <h5>Affiliate Crowdfunding Program</h5>
                </div>
                ...
                <div class="panel-body">
                    ...
                    <div class="col-md-8">
                        <p class="myp">Let me ask you a question, if there was a way for you to launch your own dream project with "Other People's Money" (O.P.M.) would you be interested in the following details below?</p>
                        <ul>
                        ...
                        <p class="myp">
                            As a result of this launch, we want to educate you on how to implement your Business Niche through our Marketing Strategies for the purposes of Crowdfunding Success. When you discover the secrets on how to use our revolutionary affiliate program to raise the capital for whatever your personal endeavors are, it will drastically change your life!<br>
                ...
                <div class="panel-footer text-center">
                    Register for our Affiliate Crowdfunding Program via your MCCS My Account >> Referal Tab
                </div>
