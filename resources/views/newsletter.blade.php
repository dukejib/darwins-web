...
@if($option == 1)
    ...
    <div class="panel panel-primary">
        ...
        By subscribing to our newsletter, you are agreeing to allow us to send you solicited emails from time to time. We advise you to add  <em> <a href="mailto:mailman@morecreditcardservices.com"> mailman@morecreditcardservices.com </a> </em> to your email whitelist contacts.
        </div>
