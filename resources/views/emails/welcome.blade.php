...
<body style="margin:0; padding:10px 0 0 0;" bgcolor="#F8F8F8">
   ...
   <p><strong>Welcome</strong> to 
    ...
    <p>
    <a href="#" style="text-decoration:none">Account </a>Check out your profile.
   </p>
    <a href="http://www.morecreditcardservices.com/aboutbusiness" style="text-decoration:none">Business </a> Assess yourself and know more about you.
   <p>
    </p>
    <a href="http://www.morecreditcardservices.com/affiliate/document" style="text-decoration:none">Read </a>Why becoming our affiliate is beneficial for you.
   <p>
   <p>
    <a href="http://www.morecreditcardservices.com" style="text-decoration:none">Shop </a>View and purchase products from our catalouge.
   </p>
    <strong>
    D.Richards & Team.
    </strong>
